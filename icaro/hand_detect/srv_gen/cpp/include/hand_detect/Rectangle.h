/* Auto-generated by genmsg_cpp for file /home/gmanfred/devel/ros/icaro/hand_detect/srv/Rectangle.srv */
...
struct RectangleResponse_ {
  ...
  std::vector<int32_t, typename ContainerAllocator::template rebind<int32_t>::other >  x;

  typedef std::vector<int32_t, typename ContainerAllocator::template rebind<int32_t>::other >  _y_type;
  std::vector<int32_t, typename ContainerAllocator::template rebind<int32_t>::other >  y;

  typedef std::vector<int32_t, typename ContainerAllocator::template rebind<int32_t>::other >  _width_type;
  std::vector<int32_t, typename ContainerAllocator::template rebind<int32_t>::other >  width;

  typedef std::vector<int32_t, typename ContainerAllocator::template rebind<int32_t>::other >  _height_type;
  std::vector<int32_t, typename ContainerAllocator::template rebind<int32_t>::other >  height;
...
struct MD5Sum<hand_detect::Rectangle> {
  static const char* value() 
  {
    return "7b3273445f9c6b5167df425514d4189f";
  }
