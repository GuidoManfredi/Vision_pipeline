"""autogenerated by genpy from reco_3d/OrientedBoundingBoxRequest.msg. Do not edit."""
import sys
...
class OrientedBoundingBoxRequest(genpy.Message):
  _md5sum = "c14048a419d8248cc6dec2f18fc433d3"
  _type = "reco_3d/OrientedBoundingBoxRequest"
...
"""
  ...
  _slot_types = ['sensor_msgs/PointCloud2','std_msgs/String[]']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(OrientedBoundingBoxRequest, self).__init__(*args, **kwds)
...
"""autogenerated by genpy from reco_3d/OrientedBoundingBoxResponse.msg. Do not edit."""
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
import struct
...
class OrientedBoundingBoxResponse(genpy.Message):
  _md5sum = "1b4f1795ebba1d0f7c45eb10dfcfc39c"
  _type = "reco_3d/OrientedBoundingBoxResponse"
  _has_header = False #flag to mark the presence of a Header object
  _full_text = """
int32 SUCCESS=0
int32 TF_ERROR=1
...
"""
  ...
  _slot_types = ['geometry_msgs/PoseStamped','geometry_msgs/Vector3','std_msgs/String[]','int32']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(OrientedBoundingBoxResponse, self).__init__(*args, **kwds)
      #message fields cannot be None, assign default values for those that are
...
class OrientedBoundingBox(object):
  _type          = 'reco_3d/OrientedBoundingBox'
  _md5sum = '98e3c9d1bc7a749a5524462b35d928da'
  _request_class  = OrientedBoundingBoxRequest
  _response_class = OrientedBoundingBoxResponse
